...
const manualEntries = [
  ...
  ["notificationRecipients", "Internal notification recipients", "Email messages and delivery", "", ""],
  ...
  ["emailOwnerButton", "Internal email button", "Email messages and delivery", "Open the Ontario page", "Ouvrir la page Ontario"],
