...
function brandedAdministrationUnavailable(): Response {
  return new Response(
    `<!doctype html><html lang="he" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>מערכת הניהול מתעדכנת | SpaPlus</title><meta name="robots" content="noindex,nofollow"><style>body{margin:0;min-height:100vh;display:grid;place-items:center;background:radial-gradient(circle at 85% 10%,#ffe3ef,transparent 30%),#f5f7fb;color:#172d4f;font-family:Arial,"Heebo",sans-serif}.card{width:min(500px,calc(100% - 40px));padding:44px 34px;border:1px solid #e6dfe5;border-radius:28px;background:#fff;box-shadow:0 22px 70px #172d4f1c;text-align:center}.brand{display:inline-flex;align-items:center;gap:12px;margin-bottom:26px;font-size:25px;font-weight:800;direction:ltr}.mark{width:52px;height:52px;border-radius:16px;background:#ed1766;color:#fff;display:grid;place-items:center;font-size:17px}.eyebrow{margin:0 0 10px;color:#ed1766;font-size:13px;font-weight:800;letter-spacing:.12em}h1{margin:0;font-size:34px;line-height:1.2}p{margin:16px auto 26px;max-width:380px;color:#526984;line-height:1.7}.button{display:inline-flex;align-items:center;justify-content:center;padding:14px 24px;border-radius:999px;background:#172d4f;color:#fff;text-decoration:none;font-weight:800}</style></head><body><main class="card"><div class="brand"><span class="mark">SP</span><span>SpaPlus</span></div><p class="eyebrow">מערכת ניהול</p><h1>המערכת מתעדכנת כרגע</h1><p>החיבור המאובטח מתחדש. אפשר לנסות שוב בעוד רגע. הנתונים נשמרים ולא נפגעו.</p><a class="button" href="/admin">ניסיון נוסף</a></main></body></html>`,
    {
      status: 503,
      headers: {
        "content-type": "text/html; charset=utf-8",
