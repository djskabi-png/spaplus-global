...
export default async function SpaPreviewsPage() {
  ...
  return <main className="spa-cms-shell" dir={admin.systemLocale === "he" ? "rtl" : "ltr"} lang={admin.systemLocale}><SpaPreviewManager canEdit={hasPermission(admin.role, admin.permissions, "site:global:spa-previews", "editContent")} /></main>;
}
